      ...
      <Card sx={{p: 0, pt: 1,background:tBackColor}}>
        <CardContent sx={{ p: 0, px: 2 }}>
          <TableContainer component={Paper} sx={{ mx: 0, p: 0, border: 0 }}>
            <Typography variant="subtitle1" gutterBottom sx={{ textAlign:"center", display:"flex",justifyContent:"center",background:tBackColor,marginBottom:"0px", paddingBottom:"6px"}}>
              <SignalCellularAltOutlinedIcon sx={{marginRight:"10px"}}/>  SIGNAL
            </Typography>
            <Table aria-label="simple table" sx={{background:tBackColor}}>
              ...
              <TableBody>
                {rows.map((row) => (
                  ...
                  >
                    <TableCell padding="none">
                      <Stack direction="row" justifyContent="flex-start" alignItems="center" spacing={1} sx={{padding: 1}}>
