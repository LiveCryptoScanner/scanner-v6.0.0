    ...
    <Typography variant="subtitle1" gutterBottom sx={{ textAlign:"center" }}>
      ...
      <Table aria-label="simple table">
        <TableHead style={{ background: tHeadColor }}>
          <TableRow>
            <TableCell sx={{ display:'flex', justifyContent:'flex-start', marginLeft:"10px"}}>Pair</TableCell>
        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              <TableCell>
                <Stack direction="row" spacing={0.8} justify="flex-start" alignItems="center">
                <Avatar
                    src="/images/ada.png"
